public class Main {
	...
	public static void main(String[] args) {
		...
		CampCard campcard1 = new CampCard(1, "Java / React", "Engin Demiroð" , 32);
		CampCard campcard2 = new CampCard(2, "C# / ANGULAR", "Engin Demiroð" , 100);
		CampCard campcard3 = new CampCard(3, "Temel", "Engin Demiroð" , 0);
